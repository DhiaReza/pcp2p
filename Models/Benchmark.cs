...
namespace pcp2p.Models
{
    public class Benchmark
    {
        ...
        public TestResolution? TestResolution {get;set;} // not used
        public int? TestResolutionId { get; set; } // not used
        // graphics settings,  low med high ulktra
        public TestGraphic? TestGraphic {get;set;} // not used
        public int? TestGraphicId { get; set; } // not used
        public TestPreset? TestPreset {get;set;} 
        public int? TestPresetId {get;set;}
    }
}
